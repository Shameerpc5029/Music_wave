...
class TeamsText extends StatelessWidget {
  const TeamsText({super.key});
...
These terms and conditions outline the rules and regulations for the use of Music Wave.
By using this app we assume you accept these terms and conditions. Do not continue to use Music Wave if you do not agree to take all of the terms and conditions stated on this page.
...
License
Unless otherwise stated, Music Wave and/or its licensors own the intellectual property rights for all material on Music Wave. All intellectual property rights are reserved. You may access this from Music Wave for your own personal use subjected to restrictions set in these terms and conditions.
You must not:
* Republish material from Music Wave
* Sell, rent or sub-license material from Music Wave
* Reproduce, duplicate or copy material from Music Wave
* Redistribute content from Music Wave
This Agreement shall begin on the date hereof.
Parts of this app offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Music Wave does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Music Wave, its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Music Wave shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
Music Wave reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.
...
You hereby grant Music Wave a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.
...
We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Music Wave; and (d) the link is in the context of general resource information.
...
If you are one of the organizations listed in paragraph 2 above and are interested in linking to our App, you must inform us by sending an e-mail to Music Wave. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our App, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.
...
No use of Music Wave's logo or other artwork will be allowed for linking absent a trademark license agreement.
iFrames
